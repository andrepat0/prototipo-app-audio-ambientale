...
import RecordingLiveText from './recording-live/recording-live';
  ...
  return (
    <View style={styles.recordingContainer}>
      ...
      <View style={styles.recordingDataContainer}>
        <View />
        {isRecording ?  <RecordingLiveText isRecording={isRecording} recording={recording} getRecording={getRecording} styles={styles} />: ""}
